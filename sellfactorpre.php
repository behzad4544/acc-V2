                ...
                <header>
                    <div class="row align-items-center">
                        ...
                        <div class="col-sm-5 text-end">
                            <h2 class="mb-1 text-end"> فاکتور فروش </h2>
                        </div>
                    </div>
                </header>
                <main>
                    <div class="row">
                        ...
                        <div class="col-sm-6 text-end"><strong>شماره فاکتور:</strong><?= $factor->sellfactor_id ?></div>
                                    ...
                                    <tfoot class="card-footer">
                                        <tr>
                                            <td class="text-center">
                                                <strong><?= number_format($factor->sell_off) ?></strong>
                                            </td>
                                            <td colspan="4" class="text-left"><strong> :مبلغ تخفیف </strong></td>
                                        </tr>
                                        <tr>
                                            <td class="text-center"><strong> <?= number_format($factor->sell_sum)   ?>
                                                </strong></td>
