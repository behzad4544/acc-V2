...
foreach ($products as $product) { ?>
                                            <tr class="clickable-row">
                                                <td class="col-3 text-center" style=" border: 1px solid"><a
                                                        href="./productdetail.php?id=<?= $product->product_id ?>"><?= $product->wearhouse_name ?></a>
                                                </td>
                                                <td class="col-3 text-center" style=" border: 1px solid"><a
                                                        href="./productdetail.php?id=<?= $product->product_id ?>"><?= $product->stock ?></a>
                                                </td>
                                                <td class="col-3 text-center" style=" border: 1px solid"><a
                                                        href="./productdetail.php?id=<?= $product->product_id ?>"><?= $product->product_name ?></a>
                                                </td>
                                                <td class="col-3 text-center" style=" border: 1px solid"><a
                                                        href="./productdetail.php?id=<?= $product->product_id ?>"><?= $i ?></a>
                                                </td>
                                            </tr>
                                            <?php ++$i;
} ?>
