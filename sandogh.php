                                ...
                                <div class="table-responsive usertable">
                                    <table class="table mb-0 table-hover" id="myTable2">
                                        <thead class="card-header">
                                            <tr>
                                                <th onclick="sortTable(0)" class="col-3 text-center"><strong>
                                                        بدهکار/بستانکار</strong></th>
                                                <th onclick="sortTable(1)" class="col-3 text-center"><strong>
                                                        مانده</strong></th>
                                                <th onclick="sortTable(2)" class="col-3 text-center"><strong> نام بانک
                                                    </strong></th>
...
foreach ($banks as $bank) { ?>
                                            <tr class="clickable-row">
                                                ...
                                                <td class="col-3 text-center"><strong> <a
                                                            style="text-decoration: none; color:black;"
                                                            href="./persondetail.php?id=<?= $bank->cust_id ?>"><?= abs($bank->total_credit) ?></a>
                                                    </strong></td>
                                                <td class="col-3 text-center"><strong><a
                                                            style="text-decoration: none; color:black;"
                                                            href="./persondetail.php?id=<?= $bank->cust_id ?>"><?= $bank->cust_name ?></a>
                                                    </strong></td>
                                                <td class="col-3 text-center"><strong> <a
                                                            style="text-decoration: none; color:black;"
                                                            href="./persondetail.php?id=<?= $bank->cust_id ?>"><?= $i ?></a>
                                                    </strong></td>
