            ...
            <form action="" method="POST" class="buyform form-group was-validated ">
                ...
                <div class="content">
                    ...
                    <div class="input-box">
                        ...
                        <input type="text" placeholder="نام و نام خانوادگی را وارد کنید " name="user_firstName" required>
                        <div class="invalid-feedback">
                    ...
                    <div class="input-box">
                        ...
                        <input type="password" placeholder="پسورد را دوباره وارد کنید" name="user_password_two" required>
                        <div class="invalid-feedback">
